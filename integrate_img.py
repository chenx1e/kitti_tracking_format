...
def main(root, mode, output_dir):
    ...
    for seq in seq_list:
        ...
        for file in img_files:
            ...
            correct_file_name = str(correct_file_name).zfill(6) + '.png'

            source_path = os.path.join(img_path, seq, file)
...
if __name__ == '__main__':
    ...
    output_dir = os.path.join(root, mode + '_for_detection', 'image_02')
